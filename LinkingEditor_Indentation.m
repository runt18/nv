...
- (IBAction)shiftLeftAction:(id)sender {	
	...
	while ((item = [enumerator nextObject])) {
		...
		NSInteger numberOfLines = 0, locationOfFirstLine = [completeString lineRangeForRange:NSMakeRange(temporaryLocation, 0)].location;
...
- (IBAction)shiftRightAction:(id)sender {
	...
	NSUInteger replacementStringLength = [replacementString length];
